...
{
  "displayName": "LINEヤフー広告（検索広告） - コンバージョン測定タグ",
  "description": "LINEヤフー広告（検索広告）のコンバージョン測定タグです。\n※タグの実行順序について注意点があります。下の「リンク」にある「ドキュメント」をクリックしてご確認ください。",
...
[
  {
    "displayName": "\u003ca href\u003d\"https://ads-help.yahoo-net.jp/s/article/H000044505?language\u003dja\"\u003eコンバージョン測定（検索広告）について\u003c/a\u003e\u003cbr\u003e\n※タグの実行順序について注意点があります。上の「コンバージョン測定（検索広告）について」をクリックしてドキュメントをご確認ください。\u003cbr\u003e\u003cbr\u003e",
    "name": "product_link",
    "type": "LABEL"
  },
  {
    "help": "コンバージョン測定タグに記載されているコンバージョンIDを入力してください。",
    "displayName": "コンバージョンID",
...
const onSuccess = () => {
  ...
  ytag({
      type:'yss_conversion',
      config:{
        yahoo_conversion_id: data.conversion_id,
        yahoo_conversion_label: data.conversion_label,
        yahoo_conversion_value: data.conversion_value,
      }
  });  
  data.gtmOnSuccess();
};
